...
mask_generator = SamAutomaticMaskGenerator(
    ...
    pred_iou_thresh=0.5,         # default confidence threshold for masks
    stability_score_thresh=0.7,  # default stability filter (lower → more masks)
...
min_circularity = 0.63 # 1 is a perfect circle, 0 is a line
